...
export interface ApiCarCar extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    userManuals: Attribute.Component<'car-user-manuals.user-manual', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiParticipantParticipant extends Schema.CollectionType {
  ...
  attributes: {
    ...
    organization: Attribute.Relation<
      ...
      'api::organization.organization'
    >;
    participant_trainings: Attribute.Relation<
      'api::participant.participant',
      'oneToMany',
      'api::participant-training.participant-training'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiParticipantTrainingParticipantTraining
  extends Schema.CollectionType {
  collectionName: 'participant_trainings';
  info: {
    singularName: 'participant-training';
    pluralName: 'participant-trainings';
    displayName: 'Participant Training';
  };
  options: {
  ...
  attributes: {
    ...
    >;
    Certificate: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiTrainingTraining extends Schema.CollectionType {
  ...
  attributes: {
    training_code: Attribute.String & Attribute.Unique;
    name: Attribute.String;
    participant_trainings: Attribute.Relation<
      'api::training.training',
      'oneToMany',
      'api::participant-training.participant-training'
    >;
    training_date_validity: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::training.training',
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::participant-training.participant-training': ApiParticipantTrainingParticipantTraining;
